...
/**
* получение данных  через отправку HTTP GET запроса 
* @param url URL запроса, например http://site.com:8000/path?param1=value1&param2=value2
...
* @param url URL запроса, например http://site.com:8000/path
* @param data данные запроса в виде строки param1=value1&param2=value2...
* @param callback функция обратного вызова, в которую передается результат 
**/
