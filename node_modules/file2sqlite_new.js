...
if ( db_file == undefined ){
	console.log('db_file not defined; Usage: file2sqlite_new <db_file> <lat_min> <lat_max> <lng_min> <lng_max>');
	process.exit(0);
}
...
if ( argv.length == 3 && ( argv[2] == '-h' || argv[2] == '--help')){
	console.log('Usage: file2sqlite_new <db_file>  <lat_min> <lat_max> <lng_min> <lng_max>');
	process.exit(0);
...
var sql_opt = "PRAGMA journal_mode = MEMORY";
db.run(sql_opt);
...
loadFileToDb('ETOPO1_Ice_g_int.xyz', 12288);
